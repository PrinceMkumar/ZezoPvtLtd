...
export default function Transport_Trip_Active
(props) {
  ...
  async function handleClick()
  {
    const result = await axios.get(
      "http://localhost:8080/api/vehicle/active", { params: { username : localStorage.getItem('username') } });
  ...
  <center><h3>Active Trips</h3></center><br></br>
  <div class="media">
