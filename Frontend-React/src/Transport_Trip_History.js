...
export default function Transport_Trip_History
(props) {
  ...
  async function handleClick()
  {
    const result = await axios.get(
      "http://localhost:8080/api/vehicle/completed", { params: { username : localStorage.getItem('username') } });
  ...
  <center><h3>Trip History</h3></center><br></br>
  <div class="media">
