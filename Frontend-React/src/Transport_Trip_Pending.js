...
export default function Transport_Trip_Pending
(props) {
  ...
  async function handleClick()
  {
    const result = await axios.get(
      "http://localhost:8080/api/vehicle/pending", { params: { username : localStorage.getItem('username') } });
  ...
  return (
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      ...
      <ul class="navbar-nav offset-3">
        ...
        <li class="nav-item">
          <a class="nav-link mt-1" onClick={handleClick} href="/"><h5>Logout</h5></a>
        </li>
        <form class="d-flex">
  ...
  <center><h3>Pending Trips</h3></center><br></br>
  <div class="media">
