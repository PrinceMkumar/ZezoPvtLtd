...
export default function UserProfile_Edit
(props) {
...
//    const [password, setPassword] = useState("");
   ...
   async function handleSubmit(event)
    ...
    try
        {
         await axios.put("http://localhost:8080/api/users/"+localStorage.getItem('userId'),
        {
  ...
  <fieldset>
    ...
    <div class="form-group">
      <label for="exampleUserName" class="form-label mt-4">Full Address</label>
      <input type="text" name="transportername"  class="form-control" id="exampleTransporterName" placeholder="Enter Address"  
      onChange={(event) =>
                {
    ...
    {vehicles.map(function fin(props)
    {
      ...
      <tr class="table-active mt-5">
        ...
        <h5><span className="col-4 "><strong>User Name :</strong></span><span>{props.username}</span></h5><br></br>
        <h5><span className="col-4"><strong>User Email :</strong></span><span>{props.useremail}</span></h5><br></br>
        <h5><span className="col-4"><strong>Phone Number :</strong></span><span>{parseInt(props.phone)}</span></h5><br></br>
        <h5><span className="col-4"><strong>Full Address :</strong></span><span>{props.fulladdress}</span></h5>
