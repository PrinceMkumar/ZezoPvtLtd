...
export default function User_Order_Pending
() {
  ...
  async function handleClick()
  {
    const result = await axios.get(
      "http://localhost:8080/api/vehicles/requestedusers", { params: { userid: localStorage.getItem('userId') } });
  ...
  return (
   ...
   <br></br>       
  <center><h3>Requested Trips</h3></center><br></br>
  <div class="media">
